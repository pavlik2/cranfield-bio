...
LearningSet::LearningSet(int Instances,int Numinputs,int Numoutputs,float* input,float* output){
	numOfInstances=Instances;
	numOfInputsPerInstance=Numinputs;
	numOfOutputsPerInstance=Numoutputs;
	inputs=input;
	outputs=output;
}
